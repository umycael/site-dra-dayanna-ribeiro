...
const WA_MESSAGE = encodeURIComponent(
  "Olá, Dra. Dayanna! Gostaria de aperfeiçoar minha prática. Podemos conversar sobre uma mentoria?"
);
const WA_HREF = `https://wa.me/553898077395?text=${WA_MESSAGE}`;

export default function MentorshipFinalCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Conte qual procedimento você deseja aperfeiçoar e vamos conversar sobre a mentoria ideal para você.
        </motion.p>
