...
export default function Footer() {
  ...
  // Animação discreta dos blocos (quase sem deslocamento)
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left gap-10 mb-14">
          ...
          <motion.div
            ...
            className="flex flex-col items-center md:items-start gap-3 font-sans text-sm"
          >
            <a
              href="https://wa.me/553898077395?text=Ol%C3%A1%2C+vim+pelo+seu+site+de+atendimentos%21&utm_source=chatgpt.com"
              target="_blank"
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center md:items-start">
            ...
            >
              ...
              >
                <ArrowUp
                  size={12}
                  className="group-hover:text-[#C59A3D] transition-colors duration-300"
                />
              </span>
            </motion.button>
          </motion.div>
