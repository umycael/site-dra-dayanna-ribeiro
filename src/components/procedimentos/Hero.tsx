    ...
    <section className="relative w-full bg-dark text-white overflow-hidden">
      ...
      <div className="lg:hidden relative min-h-[100svh] flex flex-col">
        ...
        <div className="relative h-[60vh] md:h-[65vh] w-full shrink-0 overflow-hidden">
          ...
          >
            <picture>
              <source srcSet="/images/atendimentos/hero/hero.webp" type="image/webp" />
              <img
                src="/images/atendimentos/hero/hero.png"
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-[9px] md:text-[10px] uppercase tracking-[0.25em] font-sans text-neutral-400 mb-8 md:mb-10 self-start text-left">
            Biomédica · Harmonização Corporal e Facial
          </motion.p>

          <motion.a
            variants={ctaVariants}
            whileTap={{ scale: 0.98 }}
            href="https://api.whatsapp.com/send/?phone=553898077395&text=Ol%C3%A1%2C+vim+pelo+seu+site+de+atendimentos+e+desejo+agendar+uma+avalia%C3%A7%C3%A3o%21&type=phone_number&app_absent=0&utm_source=chatgpt.com"
            target="_blank"
          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            <motion.div variants={itemVariants} className="mb-10">
              ...
              <p className="text-[10px] uppercase tracking-[0.25em] font-sans text-neutral-400 mt-2">
                Biomédica · Harmonização Corporal
              </p>
            </motion.div>
